...
public class InfectionCase {
	private String dateRep; //Date the cases were reported
	private int newConfCases; //Number of newly confirmed cases
	private int newDeaths; //Number of confirmed deaths
	/**
